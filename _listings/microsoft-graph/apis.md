...
- name: Microsoft Graph API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/attachments/master/_listings/microsoft-graph/me-mailfolders-id-childfolders-id-messages-id-attachments-id-get.md
x-common:
- type: x-change-loge
