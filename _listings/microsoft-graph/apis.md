...
- name: Microsoft Graph API List Attachments
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/attachments/master/_listings/microsoft-graph/users-id-|-userprincipalname-calendars-id-events-id-attachments-get.md
x-common:
- type: x-change-loge
