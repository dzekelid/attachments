...
- name: Microsoft Graph API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/attachments/master/_listings/microsoft-graph/users-id-|-userprincipalname-mailfolders-id-messages-id-attachments-get.md
x-common:
- type: x-change-loge
